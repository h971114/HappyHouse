		...
		<div class="row">
			<div class="col-lg-12 col-md-16 mx-auto">
				<div class="delete-header">
					<h4 class="delete-title text-secondary"><strong>회원 탈퇴</strong></h4>
					<h5 class="delete-title2 text-secondary"><strong>회원 탈퇴 시 모든 정보가 삭제되며, 이후 복구가 불가능합니다.</strong></h5>
					<hr>
				</div>
				<form name="sentDelete" id="deleteForm" method="post" action="${root}/member/remove" novalidate>
					<input type="hidden" name="act" value="regist">
						<br>
						<div align="right" class="delete-footer">
