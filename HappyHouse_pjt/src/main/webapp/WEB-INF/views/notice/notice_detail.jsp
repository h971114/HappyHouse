  ...
  <!-- Navigation -->
	...
	<div class="container">
		<div style="text-align: right;">
			<a class="display-5" href="javascript:history.back()">목록으로</a>
		</div>
		<table class="table">
			<tr>
				<td style="width:90%"><b>${notice.title}</b></td>
				<td style="width:10%"><small>조회수 ${notice.hit}</small></td>
			</tr>
			<tr style="height:100%"><td colspan="2">${notice.content}</td></tr>
		</table>
	</div>
